...
## PaaS
  ...
  * [Deta](https://www.deta.space) – Deploy unlimited number of apps like Node.js, Python, Go and Rust for free, several frameworks are also available. Includes free DBs, Auth and email.
